...
const experiences: Experience[] = [
  {
    title: "Coordinator Of Equipment Division - BINUS Catholic Student Association",
  ...
  return (
    <div id="about" className="w-full bg-black px-12 scroll-mt-24 py-4">
      ...
      <p className="flex flex-col justify-center items-center text-white mt-5 md:mx-5 text-justify text-lg md:text-xl">
        As an undergraduate student at Binus University majoring in Computer
        Science, I actively explore opportunities to improve my skills and gain
        practical experience. I am heavily involved in campus organizations and
        academic activities, where I challenge myself to grow both personally
        and professionally. With a strong passion for problem-solving and
        dedication to overcoming challenges, I constantly push myself to learn
        new concepts and technologies, aiming to make meaningful contributions
        to every project or team I join.
      </p>
            ...
            {experiences.map((item, index) => (
              <li key={index} className="mb-8 ml-8 relative">
                ...
                <div className="bg-neutral-900 p-6 rounded-xl shadow-lg">
                  ...
                  {item.description && (
                    <p className="mt-3 text-gray-300 text-justify">{item.description}</p>
                  )}
